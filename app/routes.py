...
def login():
    ...
    form = LoginForm()
    # form.validate_on_submit method does all the form processing work.
...
def explore():
    """
    Since this page is going to be very similar to the homepage
    we are referencing the index.html template. The important
    difference here though is that we do not want to have
    a form to write blog posts on this page, so in this view
    function we do not include the 'form' argument in the
    template call.
    """
    page = request.args.get('page', 1, type=int)
