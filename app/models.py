...
#decoartor. The id that Flask-Login passes to the function is going to be a string
#so databases that user numeric IDs need to convert the string to integer
@login.user_loader
def load_user(id):
